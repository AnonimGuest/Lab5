...
// foo1 -- the copy constructor was called once in this function 
...
// foo3 -- the copy constructor was called once in this function 
GameCharacter foo3(GameCharacter& p) {
	return p;
}

// foo4 -- the copy constructor is called zero times in this function 
GameCharacter& foo4(GameCharacter p) {
	return p;
}

// foo5 -- the copy constructor is called once in this function 
